...
class PlaceSelectionProvider with ChangeNotifier {
  ...
  void select(
    ...
    required List<PlaceMustItem> placeItems,
  }) {
    ...
    final placeUploads =
        selectionStatus.entries
            ...
            .toList();
    final placeScore = getCorrectPercentage(
      customerId: customerId,
      placeItems: placeItems,
    ).clamp(0.0, 100.0);
    final placeScoreCompetition = getCompetitionScore(
      customerId: customerId,
      placeItems: placeItems,
    ).clamp(0.0, 100.0);
    missionUploadProvider.setPlaceUploads(
      customerId: int.parse(customerId),
      placeUploads: placeUploads,
      placeScore: placeScore.toString(),
      placeScoreCompetition: placeScoreCompetition.toString(),
    );
    notifyListeners();
  }
